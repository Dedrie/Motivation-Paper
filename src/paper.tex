...
\usepackage[bookmarks=true, urlcolor=blue, linkcolor=blue, hidelinks=true, citecolor=blue, colorlinks=true, pdftitle={Intrinsic Motivation in Software Develoeprs}, pdfauthor={Dedrie Beardsley, Rahul Gopinath}]{hyperref}
